...
// push: Adiciona um elemento no final do array e devolve o novo tamanho do arra
let tamanho = arr.push("Boremir")
console.log(arr)
console.log(tamanho)

// unshift: Adiciona um elemento no começo do array e devolve o novo tamanho do array
tamanho = arr.unshift("Boremir")
console.log(arr)
console.log(tamanho)

// pop: Remove um elemento no final do array e devolve o elemento removid
let elementoRemovido = arr.pop("Boremir")
console.log(arr)
console.log(elementoRemovido)

// shift: Remove um elemento no começo do array e devolve o elemento removido
elementoRemovido = arr.shift("Boremir")
console.log(arr)
console.log(elementoRemovido)
...
const sociedade = hobbits.concat(outros, "Boremir")
